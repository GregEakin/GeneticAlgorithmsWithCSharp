...
public class PiTests
{
    ...
    private static bool ApproximatePi(IReadOnlyCollection<int> bitValues, int? maxSeconds = null)
    {
        ...
        void FnDisplay(Chromosome<bool, double> candidate) =>
            Display(candidate, watch, bitValues);
        ...
        var best = Genetic<bool, double>.GetBest(FnGetFitness, length, optimalFitness, geneSet, FnDisplay, FnMutate,
    ...
    public void OptimizeTest()
    {
        ...
        var _ = Genetic<int, double>.GetBest(FnGetFitness, length, optimalFitness, geneSet, FnDisplay, null,
